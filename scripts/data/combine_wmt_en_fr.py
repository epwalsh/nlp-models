...
def get_opts() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--en", type=str, default=ENGLISH_PATH, help="""Path to English file."""
    )
    parser.add_argument(
        "--fr", type=str, default=FRENCH_PATH, help="""Path to French file."""
    )
    parser.add_argument(
        "-o", "--out", type=str, default=COMBINED, help="""Path to output file."""
    )
