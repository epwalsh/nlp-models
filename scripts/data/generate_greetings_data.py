...
def get_opts() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--out-train", type=str, default="../../data/greetings/train.tsv"
    )
    parser.add_argument(
        "--out-validation", type=str, default="../../data/greetings/validation.tsv"
    )
...
def main() -> None:
    ...
    generate_data(opts.out_train, opts.train_count, first_names, last_names, templates)
    generate_data(
        opts.out_validation, opts.validation_count, first_names, last_names, templates
    )
