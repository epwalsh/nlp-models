...
class BLEU(Metric):
    ...
    def __init__(
        ...
        warnings.warn(
            "This BLEU implementation has been contributed to AllenNLP, "
    ...
    def _get_valid_tokens_mask(self, tensor: torch.LongTensor) -> torch.Tensor:
